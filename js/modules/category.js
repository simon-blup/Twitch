    ...
    App.modules.category = {
        ...
        render: function() {
            ...
            var html = '<div id="category-view" style="padding: 40px 0; color: white; width: 100%; overflow-x: hidden;">' +
                    '<div style="display:-webkit-flex; display:flex; -webkit-align-items:center; align-items:center; margin-bottom:50px; padding: 0 80px;">' +
                        '<img src="' + boxArt + '" onerror="this.src=\'icon.png\'" style="width:120px; height:160px; border-radius:10px; box-shadow:0 10px 30px rgba(0,0,0,0.5); margin-right:40px; -webkit-flex-shrink:0; flex-shrink:0;">' +
                        '<div>' +
